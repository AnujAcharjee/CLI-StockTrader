...
class Store {
  ...
  public:
    ...
    static unordered_map<string, shared_ptr<Stock>> getStocksMapSnapshot();
    static vector<shared_ptr<Order>> getOrderVectorSnapshot();
    static vector<vector<string>> getExecutedOrdersSnapshot();
};